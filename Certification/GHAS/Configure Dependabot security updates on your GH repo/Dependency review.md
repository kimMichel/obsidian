...
Dependency review allows you to "shift left". You can use the provided predictive information yo catch vulnerable dependencies before they hit production. By checking the dependency review in a pull request and changing any dependencies that are flagged as vulnerable, you can avoid vulnerabilities being added to your project.
...
![[Pasted image 20251204104255.png]]
...
If you're already familiar with Github Actions, another approach to start with dependency review is through the Github marketplace. From here, you can learn what the dependency-review-action workflow does and copy sample code to use in your project.
...
1. Create a YAML configuration file (Ex. ``dependency-review-configuration.yml``) in the repository. For example, a dependency review configuration file might look like:
...
We've only scratched the surface here. There are many dependency review configuration options available to fine-tune dependency review. Before you implement dependency review, there are a few considerations of which to be aware:
...
![[Pasted image 20251204105642.png]]
...
![[Pasted image 20251204110439.png]]

Here's an example dependency review with no issues:

![[Pasted image 20251204110506.png]]
